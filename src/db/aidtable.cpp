...
TOOL el_tools[] =
{
	...
	/* user interface */
	{x_((char*)"user"), TOOLON | TOOLINCREMENTAL | USEDIALOGS, 0, &us_userp, NOCLUSTER,
	...
	/* I/O module */
	{x_((char*)"io"), 0, 0, &io_iop, NOCLUSTER,
...
#if COMTOOL
	/* compaction module */
	{x_((char*)"compaction"), TOOLSYNTHESIS,              0, &com_compactp, NOCLUSTER,
	...
	{x_((char*)"pla"), TOOLSYNTHESIS,                     0, &pla_plap, NOCLUSTER,
...
#if ROUTTOOL
	/* wire routing module */
	{x_((char*)"routing"), TOOLINCREMENTAL | TOOLSYNTHESIS, 0, &ro_routerp, NOCLUSTER,
	...
	{x_((char*)"silicon-compiler"), TOOLSYNTHESIS,	0,	&sc_silcomp,	NOCLUSTER,
	...
	{x_((char*)"vhdl-compiler"), TOOLSYNTHESIS,	0,	&vhdl_comp,	NOCLUSTER,
...
#if COMPENTOOL
	/* compensation module */
	{x_((char*)"compensation"), TOOLSYNTHESIS,	0,	&compen_compensatep,	NOCLUSTER,
	...
	{x_((char*)"logeffort"), TOOLSYNTHESIS,	0,	&le_tablep,	NOCLUSTER,
	...
	{x_((char*)"network"), TOOLON | TOOLINCREMENTAL, 0, &net_networkp, NOCLUSTER,
...
#if DRCTOOL
	/* design-rule checker */
	{x_((char*)"drc"), TOOLON | TOOLINCREMENTAL | TOOLANALYSIS, 0, &dr_drcp, NOCLUSTER,
	...
	{x_((char*)"erc"), TOOLANALYSIS, 0, &erc_tablep, NOCLUSTER,
...
#if SIMTOOL
	/* simulation module */
	{x_((char*)"simulation"), TOOLON|TOOLANALYSIS, 0, &sim_simulatorp, NOCLUSTER,
	...
	{x_((char*)"project"), TOOLON | TOOLINCREMENTAL, 0, &proj_projp, NOCLUSTER,
