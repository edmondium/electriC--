...
TECHNOLOGY *defschematictechnology(TECHNOLOGY *deftech)
{
	...
	var = getval((INTBIG)sch_tech, VTECHNOLOGY, VSTRING, x_((char*)"TECH_layout_technology"));
	if (var != NOVARIABLE)
	{
...
{
	INTBIG pindex, count, reasonablecount, cutcount, displayablepolys;
	INTBIG fewer;
	TECH_NODES *thistn;
	NODEPROTO *np;
...
{
	INTBIG pindex, count, reasonablecount, cutcount;
	INTBIG fewer;
	TECH_NODES *thistn;
...
{
	{N_((char*)"unknown"),						N_((char*)"node"),     x_((char*)"NPUNKNOWN")},	/* NPUNKNOWN */
	{N_((char*)"pin"),							N_((char*)"pin"),      x_((char*)"NPPIN")},		/* NPPIN */
	{N_((char*)"contact"),						N_((char*)"contact"),  x_((char*)"NPCONTACT")},	/* NPCONTACT */
	{N_((char*)"pure-layer-node"),				N_((char*)"plnode"),   x_((char*)"NPNODE")},		/* NPNODE */
	{N_((char*)"connection"),					N_((char*)"conn"),     x_((char*)"NPCONNECT")},	/* NPCONNECT */
	{N_((char*)"nMOS-transistor"),				N_((char*)"nmos"),     x_((char*)"NPTRANMOS")},	/* NPTRANMOS */
	{N_((char*)"DMOS-transistor"),				N_((char*)"dmos"),     x_((char*)"NPTRADMOS")},	/* NPTRADMOS */
	{N_((char*)"pMOS-transistor"),				N_((char*)"pmos"),     x_((char*)"NPTRAPMOS")},	/* NPTRAPMOS */
	{N_((char*)"NPN-transistor"),				N_((char*)"npn"),      x_((char*)"NPTRANPN")},	/* NPTRANPN */
	{N_((char*)"PNP-transistor"),				N_((char*)"pnp"),      x_((char*)"NPTRAPNP")},	/* NPTRAPNP */
	{N_((char*)"n-type-JFET-transistor"),		N_((char*)"njfet"),    x_((char*)"NPTRANJFET")},	/* NPTRANJFET */
	{N_((char*)"p-type-JFET-transistor"),		N_((char*)"pjfet"),    x_((char*)"NPTRAPJFET")},	/* NPTRAPJFET */
	{N_((char*)"depletion-mesfet"),			N_((char*)"dmes"),     x_((char*)"NPTRADMES")},	/* NPTRADMES */
	{N_((char*)"enhancement-mesfet"),			N_((char*)"emes"),     x_((char*)"NPTRAEMES")},	/* NPTRAEMES */
	{N_((char*)"prototype-defined-transistor"),N_((char*)"tref"),     x_((char*)"NPTRANSREF")},	/* NPTRANSREF */
	{N_((char*)"transistor"),					N_((char*)"trans"),    x_((char*)"NPTRANS")},		/* NPTRANS */
	{N_((char*)"4-port-nMOS-transistor"),		N_((char*)"nmos4p"),   x_((char*)"NPTRA4NMOS")},	/* NPTRA4NMOS */
	{N_((char*)"4-port-DMOS-transistor"),		N_((char*)"dmos4p"),   x_((char*)"NPTRA4DMOS")},	/* NPTRA4DMOS */
	{N_((char*)"4-port-pMOS-transistor"),		N_((char*)"pmos4p"),   x_((char*)"NPTRA4PMOS")},	/* NPTRA4PMOS */
	{N_((char*)"4-port-NPN-transistor"),		N_((char*)"npn4p"),    x_((char*)"NPTRA4NPN")},	/* NPTRA4NPN */
	{N_((char*)"4-port-PNP-transistor"),		N_((char*)"pnp4p"),    x_((char*)"NPTRA4PNP")},	/* NPTRA4PNP */
	{N_((char*)"4-port-n-type-JFET-transistor"),N_((char*)"njfet4p"), x_((char*)"NPTRA4NJFET")},	/* NPTRA4NJFET */
	{N_((char*)"4-port-p-type-JFET-transistor"),N_((char*)"pjfet4p"), x_((char*)"NPTRA4PJFET")},	/* NPTRA4PJFET */
	{N_((char*)"4-port-depletion-mesfet"),		N_((char*)"dmes4p"),   x_((char*)"NPTRA4DMES")},	/* NPTRA4DMES */
	{N_((char*)"4-port-enhancement-mesfet"),	N_((char*)"emes4p"),   x_((char*)"NPTRA4EMES")},	/* NPTRA4EMES */
	{N_((char*)"4-port-transistor"),			N_((char*)"trans4p"),  x_((char*)"NPTRANS4")},	/* NPTRANS4 */
	{N_((char*)"resistor"),					N_((char*)"res"),      x_((char*)"NPRESIST")},	/* NPRESIST */
	{N_((char*)"capacitor"),					N_((char*)"cap"),      x_((char*)"NPCAPAC")},		/* NPCAPAC */
	{N_((char*)"electrolytic-capacitor"),		N_((char*)"ecap"),     x_((char*)"NPECAPAC")},	/* NPECAPAC */
	{N_((char*)"diode"),						N_((char*)"diode"),    x_((char*)"NPDIODE")},		/* NPDIODE */
	{N_((char*)"zener-diode"),					N_((char*)"zdiode"),   x_((char*)"NPDIODEZ")},	/* NPDIODEZ */
	{N_((char*)"inductor"),					N_((char*)"ind"),      x_((char*)"NPINDUCT")},	/* NPINDUCT */
	{N_((char*)"meter"),						N_((char*)"meter"),    x_((char*)"NPMETER")},		/* NPMETER */
	{N_((char*)"base"),						N_((char*)"base"),     x_((char*)"NPBASE")},		/* NPBASE */
	{N_((char*)"emitter"),						N_((char*)"emit"),     x_((char*)"NPEMIT")},		/* NPEMIT */
	{N_((char*)"collector"),					N_((char*)"coll"),     x_((char*)"NPCOLLECT")},	/* NPCOLLECT */
	{N_((char*)"buffer"),						N_((char*)"buf"),      x_((char*)"NPBUFFER")},	/* NPBUFFER */
	{N_((char*)"AND-gate"),					N_((char*)"and"),      x_((char*)"NPGATEAND")},	/* NPGATEAND */
	{N_((char*)"OR-gate"),						N_((char*)"or"),       x_((char*)"NPGATEOR")},	/* NPGATEOR */
	{N_((char*)"XOR-gate"),					N_((char*)"xor"),      x_((char*)"NPGATEXOR")},	/* NPGATEXOR */
	{N_((char*)"flip-flop"),					N_((char*)"ff"),       x_((char*)"NPFLIPFLOP")},	/* NPFLIPFLOP */
	{N_((char*)"multiplexor"),					N_((char*)"mux"),      x_((char*)"NPMUX")},		/* NPMUX */
	{N_((char*)"power"),						N_((char*)"pwr"),      x_((char*)"NPCONPOWER")},	/* NPCONPOWER */
	{N_((char*)"ground"),						N_((char*)"gnd"),      x_((char*)"NPCONGROUND")},	/* NPCONGROUND */
	{N_((char*)"source"),						N_((char*)"source"),   x_((char*)"NPSOURCE")},	/* NPSOURCE */
	{N_((char*)"substrate"),					N_((char*)"substr"),   x_((char*)"NPSUBSTRATE")},	/* NPSUBSTRATE */
	{N_((char*)"well"),						N_((char*)"well"),     x_((char*)"NPWELL")},		/* NPWELL */
	{N_((char*)"artwork"),						N_((char*)"art"),      x_((char*)"NPART")},		/* NPART */
	{N_((char*)"array"),						N_((char*)"array"),    x_((char*)"NPARRAY")},		/* NPARRAY */
	{N_((char*)"align"),						N_((char*)"align"),    x_((char*)"NPALIGN")},		/* NPALIGN */
	{N_((char*)"ccvs"),						N_((char*)"ccvs"),     x_((char*)"NPCCVS")},		/* NPCCVS */
	{N_((char*)"cccs"),						N_((char*)"cccs"),     x_((char*)"NPCCCS")},		/* NPCCCS */
	{N_((char*)"vcvs"),						N_((char*)"vcvs"),     x_((char*)"NPVCVS")},		/* NPVCVS */
	{N_((char*)"vccs"),						N_((char*)"vccs"),     x_((char*)"NPVCCS")},		/* NPVCCS */
	{N_((char*)"transmission-line"),			N_((char*)"transm"),   x_((char*)"NPTLINE")}		/* NPTLINE */
};
...
CHAR *nodefunctionname(INTBIG fun, NODEINST *ni)
{
	...
	{
		infstr = initinfstr();
		formatinfstr(infstr, _((char*)"Transistor-%s"), ni->proto->protoname);
		return(returninfstr(infstr));
	}
	if (fun < 0 || fun >= MAXNODEFUNCTION) return(x_((char*)""));
...
void transistorsize(NODEINST *ni, INTBIG *length, INTBIG *width)
{
	INTBIG lx, ly, hx, hy;
	INTBIG count, i;
	INTBIG fx, fy, tx, ty, lambda;
	CHAR *pt;
	VARIABLE *var, *varl, *varw;
...
BOOLEAN portisnamedpower(PORTPROTO *pp)
{
	...
	for(pt = pp->protoname; *pt != 0; pt++)
	{
		...
		if (len >= 3)
		{
			if (namesamen(pt, x_((char*)"vdd"), 3) == 0) return(TRUE);
			if (namesamen(pt, x_((char*)"pwr"), 3) == 0) return(TRUE);
			if (namesamen(pt, x_((char*)"vcc"), 3) == 0) return(TRUE);
		}
		if (len >= 5)
		{
			if (namesamen(pt, x_((char*)"power"), 5) == 0) return(TRUE);
		}
	}
	return(FALSE);
}
...
BOOLEAN portisnamedground(PORTPROTO *pp)
{
	...
	for(pt = pp->protoname; *pt != 0; pt++)
	{
		...
		if (len >= 3)
		{
			if (namesamen(pt, x_((char*)"gnd"), 3) == 0) return(TRUE);
			if (namesamen(pt, x_((char*)"vss"), 3) == 0) return(TRUE);
		}
		if (len >= 6)
		{
			if (namesamen(pt, x_((char*)"ground"), 6) == 0) return(TRUE);
		}
	}
	return(FALSE);
}
...
{
	INTBIG i, points, anglebase, anglerange, pieces, a;
	INTBIG radius, centerx, centery, innerradius, outerradius, sin, cos;
	INTBIG x1, y1, x2, y2;
	VARIABLE *var;
...
{
	INTBIG x1, y1, x2, y2, e1, e2, angle;
...
CHAR *arcfunctionname(INTBIG fun)
{
	...
	{
		N_((char*)"unknown"),				/* APUNKNOWN */
		N_((char*)"metal-1"),				/* APMETAL1 */
		N_((char*)"metal-2"),				/* APMETAL2 */
		N_((char*)"metal-3"),				/* APMETAL3 */
		N_((char*)"metal-4"),				/* APMETAL4 */
		N_((char*)"metal-5"),				/* APMETAL5 */
		N_((char*)"metal-6"),				/* APMETAL6 */
		N_((char*)"metal-7"),				/* APMETAL7 */
		N_((char*)"metal-8"),				/* APMETAL8 */
		N_((char*)"metal-9"),				/* APMETAL9 */
		N_((char*)"metal-10"),				/* APMETAL10 */
		N_((char*)"metal-11"),				/* APMETAL11 */
		N_((char*)"metal-12"),				/* APMETAL12 */
		N_((char*)"polysilicon-1"),		/* APPOLY1 */
		N_((char*)"polysilicon-2"),		/* APPOLY2 */
		N_((char*)"polysilicon-3"),		/* APPOLY3 */
		N_((char*)"diffusion"),			/* APDIFF */
		N_((char*)"p-diffusion"),			/* APDIFFP */
		N_((char*)"n-diffusion"),			/* APDIFFN */
		N_((char*)"substrate-diffusion"),	/* APDIFFS */
		N_((char*)"well-diffusion"),		/* APDIFFW */
		N_((char*)"bus"),					/* APBUS */
		N_((char*)"unrouted"),				/* APUNROUTED */
		N_((char*)"nonelectrical")			/* APNONELEC */
	};

	if (fun < 0 || fun > APNONELEC) return(x_((char*)""));
...
CHAR *layername(TECHNOLOGY *tech, INTBIG layer)
{
	...
	if (layer < 0) return(x_((char*)""));

	/* make sure cache of information is valid */
	if (tech_layer_names == 0)
	{
		tech_initlayername();
		if (tech_layer_names == 0) return(x_((char*)""));
	}

	addr = tech_layer_names[tech->techindex];
	if (addr == 0) return(x_((char*)""));
	return(addr[layer]);
}
...
BOOLEAN get3dfactors(TECHNOLOGY *tech, INTBIG layer, float *height, float *thickness)
{
	...
	{
		heightsetup = TRUE;
		db_techlayer3dheightkey = makekey(x_((char*)"TECH_layer_3dheight"));
		db_techlayer3dthicknesskey = makekey(x_((char*)"TECH_layer_3dthickness"));
...
BOOLEAN samelayer(TECHNOLOGY *tech, INTBIG layer1, INTBIG layer2)
{
	...
	INTBIG countsquared, i, first, second;
	BOOLEAN result;
	INTBIG *equivlist;
	...
	if (tech != layertabtech)
	{
		if (db_equivtable != 0) efree((CHAR *)db_equivtable);
		db_equivtable = 0;
		equivlist = (INTBIG *)asktech(tech, x_((char*)"get-layer-equivalences"));
		if (equivlist != 0)
		{
...
{
	INTBIG *layerheight, *layerthickness, i, funct;
...
{
	INTBIG pindex, temp, *addr, *edgeaddr, *multiaddr, *wideaddr, ti, dist;
	CHAR **rules, **edgerules, **multirules, **widerules;
...
{
	INTBIG i, widerules, widelimit, lambda;
